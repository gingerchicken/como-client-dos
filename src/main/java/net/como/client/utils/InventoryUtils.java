...
public class InventoryUtils {
    public static List<Integer> getItemSlots(int total, Predicate<ItemStack> isItem) {
        ...
        PlayerInventory inv = ComoClient.getInstance().me().getInventory();
    ...
    public static void moveItem(int from, int to) {
        ...
        boolean wasEmpty = ComoClient.getInstance().me().getInventory().getStack(to).isEmpty();
    ...
    public static int getFreeSlot() {
        int slot = ComoClient.getInstance().me().getInventory().getEmptySlot();
